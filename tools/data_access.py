...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 18 15:03:34 2025
...
def search_cmr_stac(baseline_year,analysis_year,lat_range,lon_range,date_begin=None,date_end=None,mgrs_tile_id=None):
...
def pystac_to_json(item_list):
    ...
    df_geo['id'] = data_id
    df_geo['mgrs_tile_id'] = [i.split('.')[2] for i in df_geo['id']]
